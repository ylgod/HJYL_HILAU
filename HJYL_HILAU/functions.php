...
function hjyl_script() {
	...
	wp_enqueue_script( 'bootstrap', 'https://cdn.bootcss.com/twitter-bootstrap/4.3.1/js/bootstrap.min.js', array(), '20191004', false );
	wp_enqueue_style('bootstrap', 'https://cdn.bootcss.com/twitter-bootstrap/4.3.1/css/bootstrap.min.css', array(), '20191004', 'all');
	wp_enqueue_script( 'hjyl', get_theme_file_uri( '/js/hjyl.js' ), array(), '20191004', true );
	if ( ! has_custom_logo() ) {
		wp_enqueue_script( 'hjyl_logo', get_theme_file_uri( '/js/logo.js' ), array(), '20191004', true );
	}
	if ( is_singular() ) {
	wp_enqueue_script( 'jquery-qrcode', 'https://cdn.bootcss.com/jquery.qrcode/1.0/jquery.qrcode.min.js', array(), '20191004', true);
	wp_enqueue_script( 'qrcode-js', get_theme_file_uri('/js/qrcode.js'), array('jquery'), '20191004', true);
	wp_enqueue_script( 'lightbox-js', 'https://cdn.bootcss.com/lightbox2/2.11.1/js/lightbox.min.js', array('jquery'), '20191004', true);
	wp_enqueue_style('lightbox', 'https://cdn.bootcss.com/lightbox2/2.11.1/css/lightbox.min.css', array(), '20191004', 'all');
	}
	if ( is_singular() && comments_open() ) {
	wp_enqueue_script( 'comment-reply' );
	wp_enqueue_script( 'ajax-comment', get_theme_file_uri('/js/comments-ajax.js'), array('jquery'), '20191004', true);
	}
